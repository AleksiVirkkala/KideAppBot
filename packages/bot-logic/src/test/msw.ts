...
export const reqHandlerVariantsMissing: RestResponseResolver = (
  req,
  res,
  ctx
) => {
  return res.once(
    ctx.status(200),
    ctx.json(eventVariantsFirstMissing.pageDataNoVariants)
  );
};

export const reqHandlerVariantsExist: RestResponseResolver = (
  req,
  res,
  ctx
) => {
  return res.once(
    ctx.status(200),
    ctx.json(eventVariantsFirstMissing.pageDataVariants)
  );
};
...
export const reqHandlerSalesEnded: RestResponseResolver = (req, res, ctx) => {
  return res.once(
    ctx.status(200),
    ctx.json(eventVariantsFirstMissing.pageDataSalesEnded)
  );
};

export const reqHandlerSalesNotStarted: RestResponseResolver = (
  req,
  res,
  ctx
) => {
  return res.once(
    ctx.status(200),
    ctx.json(eventSalesNotStarted.pageDataNotStarted)
  );
};
...
export const restHandlers = [
  ...
  rest.get(eventNon200.apiUrl, (req, res, ctx) => {
